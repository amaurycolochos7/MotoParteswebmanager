...
const styles = `
.cst-page { min-height: 100vh; background: #ffffff; color: #1d1d1f; font-family: inherit; }
.cst-header { max-width: 900px; margin: 0 auto; padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #e8e8ed; }
...
.cst-moto { color: #1d1d1f; } .cst-partes { color: #ef4444; }
.cst-nav { display: flex; gap: 18px; align-items: center; }
.cst-nav a { color: #474747; text-decoration: none; font-weight: 500; font-size: 0.92rem; }
...
.cst-back { color: #6e6e73; text-decoration: none; font-size: 0.88rem; display: inline-flex; align-items: center; gap: 4px; margin-bottom: 24px; }
.cst-back:hover { color: #ef4444; }
.cst-hero { text-align: center; padding: 30px 0 20px; border-bottom: 1px solid #e8e8ed; margin-bottom: 30px; }
.cst-pill { display: inline-flex; align-items: center; gap: 4px; background: #f5f5f7; color: #474747; padding: 4px 12px; border-radius: 999px; font-size: 0.8rem; font-weight: 600; margin-bottom: 14px; }
.cst-article h1 { font-size: 2.4rem; font-weight: 800; margin: 0 0 10px; color: #1d1d1f; letter-spacing: -1px; }
...
.cst-metric { background: white; border: 1px solid #e8e8ed; border-radius: 14px; padding: 20px; text-align: center; }
.cst-metric-label { color: #6e6e73; font-size: 0.82rem; margin-bottom: 10px; }
.cst-metric-row { display: flex; align-items: center; justify-content: center; gap: 10px; }
.cst-before { color: #86868b; text-decoration: line-through; font-size: 1rem; }
.cst-after { color: #16a34a; font-weight: 800; font-size: 1.35rem; }
.cst-metric-row svg { color: #16a34a; }
.cst-body { color: #1d1d1f; line-height: 1.75; font-size: 1.05rem; margin-top: 30px; }
.cst-body p { margin: 0 0 18px; }
.cst-body h2 { font-size: 1.45rem; font-weight: 800; margin: 36px 0 14px; color: #1d1d1f; letter-spacing: -0.3px; }
.cst-body ul, .cst-body ol { margin: 0 0 18px; padding-left: 24px; }
.cst-body li { margin-bottom: 6px; }
.cst-body strong { color: #1d1d1f; font-weight: 700; }
...
.cst-footer { text-align: center; padding: 30px 24px; background: #1d1d1f; color: #6e6e73; font-size: 0.85rem; }
`;
