...
.mp-plan-head { margin-bottom: 16px; }
.mp-plan-head h3 {
    font-size: 1.2rem;
    font-weight: 800;
    color: var(--c-ink);
...
.mp-plan-per { color: var(--c-muted); font-size: 0.84rem; font-weight: 500; }
.mp-plan-cta { width: 100%; margin-bottom: 18px; }
.mp-plan-features {
    list-style: none;
    padding: 0;
    margin: 0;
...
@media (max-width: 780px) { .mp-footer-grid { grid-template-columns: 1fr; } }
.mp-footer-brand p {
    color: #94a3b8;
    font-size: 0.9rem;
    margin: 12px 0 0;
