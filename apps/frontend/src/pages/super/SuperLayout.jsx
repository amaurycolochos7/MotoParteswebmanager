...
const styles = `
.super-shell { min-height: 100vh; display: flex; background: #0b0f1a; color: #e8e8ed; font-family: inherit; }
.super-loading { min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #0b0f1a; }
.super-spinner { width: 32px; height: 32px; border: 3px solid #1d1d1f; border-top-color: #ef4444; border-radius: 50%; animation: spin 0.9s linear infinite; }
@keyframes spin { to { transform: rotate(360deg); } }

.super-denied { min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; background: #0b0f1a; color: #e8e8ed; padding: 40px; text-align: center; }
...
.super-sidebar { width: 260px; background: #1d1d1f; border-right: 1px solid #1d1d1f; display: flex; flex-direction: column; flex-shrink: 0; position: sticky; top: 0; height: 100vh; }
.super-brand { display: flex; gap: 10px; align-items: center; padding: 18px 18px; border-bottom: 1px solid #1d1d1f; }
...
.super-brand-title { font-weight: 700; font-size: 0.95rem; color: #f5f5f7; }
.super-brand-sub { font-size: 0.75rem; color: #6e6e73; }
.super-nav { flex: 1; padding: 12px 10px; overflow-y: auto; display: flex; flex-direction: column; gap: 2px; }
.super-nav-item { display: flex; align-items: center; gap: 10px; padding: 9px 12px; border-radius: 8px; color: #86868b; text-decoration: none; font-size: 0.9rem; transition: all 0.15s; }
.super-nav-item:hover { background: #1d1d1f; color: #e8e8ed; }
...
.super-user { display: flex; align-items: center; gap: 10px; padding: 14px 12px; border-top: 1px solid #1d1d1f; }
.super-user-avatar { width: 34px; height: 34px; border-radius: 50%; background: #1d1d1f; display: flex; align-items: center; justify-content: center; font-weight: 700; color: #f5f5f7; font-size: 0.85rem; flex-shrink: 0; }
.super-user-name { font-size: 0.84rem; font-weight: 600; color: #e8e8ed; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.super-user-email { font-size: 0.72rem; color: #6e6e73; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.super-icon-btn { background: #1d1d1f; border: none; color: #86868b; padding: 7px; border-radius: 7px; cursor: pointer; transition: all 0.15s; flex-shrink: 0; }
.super-icon-btn:hover { background: #474747; color: #f5f5f7; }

.super-main { flex: 1; min-width: 0; display: flex; flex-direction: column; }
.super-topbar { display: none; align-items: center; gap: 12px; padding: 12px 16px; border-bottom: 1px solid #1d1d1f; background: #1d1d1f; }
.super-burger { background: #1d1d1f; color: #e8e8ed; border: none; padding: 8px; border-radius: 8px; cursor: pointer; }
...
.sp-card { background: #1d1d1f; border: 1px solid #1d1d1f; border-radius: 14px; padding: 20px; }
.sp-card h2 { font-size: 1rem; font-weight: 700; color: #f5f5f7; margin: 0 0 14px; }
.sp-header { display: flex; justify-content: space-between; align-items: flex-start; gap: 16px; flex-wrap: wrap; margin-bottom: 24px; }
.sp-title { font-size: 1.5rem; font-weight: 800; color: #f5f5f7; margin: 0 0 4px; letter-spacing: -0.3px; }
.sp-subtitle { color: #6e6e73; font-size: 0.92rem; margin: 0; }
...
.sp-btn-secondary { background: #1d1d1f; color: #e8e8ed; border: 1px solid #474747; padding: 9px 16px; border-radius: 9px; font-weight: 600; font-size: 0.88rem; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; transition: all 0.15s; }
.sp-btn-secondary:hover { background: #474747; }
...
.sp-input { background: #0b0f1a; color: #e8e8ed; border: 1px solid #474747; border-radius: 8px; padding: 9px 12px; font-size: 0.9rem; width: 100%; font-family: inherit; }
.sp-input:focus { outline: none; border-color: #ef4444; box-shadow: 0 0 0 3px rgba(239,68,68,0.15); }
.sp-label { display: block; font-size: 0.82rem; color: #86868b; font-weight: 600; margin-bottom: 5px; }
.sp-table-wrap { overflow-x: auto; }
.sp-table { width: 100%; border-collapse: collapse; font-size: 0.88rem; }
.sp-table th { text-align: left; padding: 12px; font-size: 0.75rem; color: #6e6e73; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600; border-bottom: 1px solid #1d1d1f; }
.sp-table td { padding: 14px 12px; border-bottom: 1px solid #1d1d1f; color: #d2d2d7; }
...
.sp-pill-gray { background: rgba(100,116,139,0.15); color: #d2d2d7; border: 1px solid rgba(100,116,139,0.3); }
...
.sp-empty { text-align: center; padding: 50px 20px; color: #6e6e73; }
`;
