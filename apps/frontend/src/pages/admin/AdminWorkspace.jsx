        ...
        (async () => {
            try {
                ...
                setForm({
                    ...
                    secondary_color: b.secondary_color || '#1d1d1f',
    ...
    return (
        <div style={{ maxWidth: 880, margin: '0 auto', padding: '24px 20px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 20, marginBottom: 24, flexWrap: 'wrap' }}>
                <div>
                    <h1 style={{ margin: 0, fontSize: '1.6rem', fontWeight: 800, color: '#1d1d1f' }}>Configuración del taller</h1>
                    <p style={{ margin: '4px 0 0', color: '#6e6e73', fontSize: '0.95rem' }}>Branding, folios y plan.</p>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 14px', background: '#f5f5f7', borderRadius: 999 }}>
            ...
            <div className="ws-grid">
                ...
                <section className="ws-card">
                    ...
                    <p style={{ color: '#6e6e73', fontSize: '0.85rem', margin: '8px 0 0' }}>
                ...
                <section className="ws-card">
                    ...
                    <div style={{ fontSize: '1.8rem', fontWeight: 800, color: '#1d1d1f', margin: '6px 0' }}>
                        {activeWorkspace?.plan?.name || 'Free'}
                    </div>
                    {activeWorkspace?.is_flagship ? (
                        <p style={{ color: '#6e6e73', fontSize: '0.88rem', margin: 0 }}>
            ...
            <style>{`
                ...
                .ws-card { background: white; border: 1px solid #e8e8ed; border-radius: 14px; padding: 20px; }
                .ws-card-head { display: flex; align-items: center; gap: 8px; margin-bottom: 14px; color: #ef4444; }
                .ws-card-head h2 { margin: 0; font-size: 1rem; font-weight: 700; color: #1d1d1f; }
                .ws-card label { display: block; font-size: 0.82rem; font-weight: 600; color: #474747; margin: 10px 0 4px; }
                .ws-card input { width: 100%; padding: 10px 12px; border: 2px solid #e8e8ed; border-radius: 8px; font-size: 0.95rem; background: #f5f5f7; }
                ...
                .ws-hex { font-family: monospace; font-size: 0.78rem; color: #6e6e73; margin-top: 4px; text-align: center; }
